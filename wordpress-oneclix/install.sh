...
/usr/local/vesta/bin/v-list-databases $USER > /tmp/db_list.txt

if grep -q $USER"_"$DBNAME /tmp/db_list.txt; then
    DBNAME=$DBNAME"_"$(grep -c $USER"_"$DBNAME /tmp/db_list.txt);
fi
DBUSER="$DBNAME"

/usr/local/vesta/bin/v-add-database $USER $DBNAME $DBUSER $DBPASS
...
rm -f /home/$USER/web/$DOMAIN/public_html/*
cp -a /tmp/wordpress/. /home/$USER/web/$DOMAIN/public_html/
...
unzip /tmp/plugins/all-in-one-wp-security-and-firewall.zip -d /home/$USER/web/$DOMAIN/public_html/wp-content/plugins/

curl -O https://downloads.wordpress.org/plugin/google-analytics-for-wordpress.zip
unzip /tmp/plugins/google-analytics-for-wordpress.zip -d /home/$USER/web/$DOMAIN/public_html/wp-content/plugins/
...
chown -R $USER:$USER /home/$USER/web/$DOMAIN/public_html/.htaccess
chown -R $USER:$USER /home/$USER/web/$DOMAIN/public_html/*
chown -R $USER:$USER /home/$USER/web/$DOMAIN/public_html/*/*
chown -R $USER:$USER /home/$USER/web/$DOMAIN/public_html/*/*/*

chmod 755 /home/$USER/web/$DOMAIN/public_html/wp-content
chmod 644 /home/$USER/web/$DOMAIN/public_html/wp-includes
chmod 644 /home/$USER/web/$DOMAIN/public_html/*.php
chmod 644 /home/$USER/web/$DOMAIN/public_html/*/*.php
chmod 644 /home/$USER/web/$DOMAIN/public_html/*/*/*.php
chmod 444 /home/$USER/web/$DOMAIN/public_html/index.php
find /home/$USER/web/$DOMAIN/public_html/ -type d -exec chmod 755 {} \;
find /home/$USER/web/$DOMAIN/public_html/ -type f -exec chmod 644 {} \;
chmod 0640 /home/$USER/web/$DOMAIN/public_html/wp-config.php

sed -i -e 's/database_name_here/'$USER'_'$DBNAME'/g' /home/$USER/web/$DOMAIN/public_html/wp-config.php
...
sed -i -e "s/define( 'NONCE_KEY',        'put your unique phrase here' );/ /g" /home/$USER/web/$DOMAIN/public_html/wp-config.php
sed -i -e "s/define( 'AUTH_SALT',        'put your unique phrase here' );/ /g" /home/$USER/web/$DOMAIN/public_html/wp-config.php
...
rm -rf /home/$USER/web/$DOMAIN/public_html/wp-content/plugins/hello.php

rm -rf /home/$USER/web/$DOMAIN/public_html/wp-content/themes/twentyseventeen/
rm -rf /home/$USER/web/$DOMAIN/public_html/wp-content/themes/twentysixteen/
rm -rf /home/$USER/web/$DOMAIN/public_html/wp-content/themes/twentynineteen/

find /home/$USER/web/$DOMAIN/public_html -type d -print0 | xargs -0 -I {} find '{}' -type f -print0 | xargs -0 -I {} chmod 0644 {};
find /home/$USER/web/$DOMAIN/public_html -type d -print0 | xargs -0 -I {} find '{}' -type f -print0 | xargs -0 -I {} chown $USER:$USER {};

find /home/$USER/web/$DOMAIN/public_html -type d -print0 | xargs -0 -I {} find '{}' -type d -print0 | xargs -0 -I {} chmod 0755 {};
find /home/$USER/web/$DOMAIN/public_html -type d -print0 | xargs -0 -I {} find '{}' -type d -print0 | xargs -0 -I {} chown $USER:$USER {};
chmod 0640 /home/$USER/web/$DOMAIN/public_html/wp-config.php
...
echo "#       DB Name: $USER_$DBNAME          #"
echo "#       DB User: $USER_$DBUSER          #"
echo "#        DB Pass: $DBPASS          #"
echo "###########################################"
...
body="$body       DB Name: $USER_$DBNAME          "
body="$body       DB User: $USER_$DBUSER          "

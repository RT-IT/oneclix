...
curl -O https://downloads.wordpress.org/plugin/wp-smushit.zip
unzip /tmp/plugins/wp-smushit.zip -d /home/admin/web/$DOMAIN/public_html/wp-content/plugins/
...
chmod 644 /home/admin/web/$DOMAIN/public_html/*/*.php
chmod 644 /home/admin/web/$DOMAIN/public_html/*/*/*.php
chmod 444 /home/admin/web/$DOMAIN/public_html/wp-config.php
